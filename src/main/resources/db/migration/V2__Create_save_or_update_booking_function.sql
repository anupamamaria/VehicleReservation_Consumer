...
BEGIN
    -- Try to find existing booking (changed "bookings" to "booking")
    ...
    IF FOUND THEN
        -- Update existing booking (changed "bookings" to "booking")
        UPDATE booking SET
    ...
    ELSE
        -- Insert new booking (changed "bookings" to "booking")
        INSERT INTO booking (
